...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/userData/generated/gameDataClient",
    "userData/generated/gameDataClient",
  ]
...
path.join(process.cwd(), "prisma/userData/generated/gameDataClient/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/userData/generated/gameDataClient/schema.prisma")
