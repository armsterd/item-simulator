...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\user\\OneDrive\\바탕 화면\\sparta\\Item-Simulator\\prisma\\userData\\generated\\userDataClient",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "d6a05ea849b15b3d38c534431de185595a1ba6a2f3b3e1b956574eafe8a5940a",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/userData/generated/userDataClient",
    "userData/generated/userDataClient",
  ]
...
path.join(process.cwd(), "prisma/userData/generated/userDataClient/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/userData/generated/userDataClient/schema.prisma")
